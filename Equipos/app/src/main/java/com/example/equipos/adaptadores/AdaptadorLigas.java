package com.example.equipos.adaptadores;
...
import com.example.equipos.utils.Liga;
...
public class AdaptadorLigas extends RecyclerView.Adapter<AdaptadorLigas.MiHolder> {
    ...
    public MiHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_liga_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull MiHolder holder, int position) {
        ...
        holder.getNombreLiga().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(context,"Para la comunicación",Toast.LENGTH_SHORT).show();
